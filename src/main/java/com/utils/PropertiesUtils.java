...
public class PropertiesUtils {
    ...
    public static String getPropertyByClassPath(String classPath, String propertyName, String defaultValue) {
	try {
	    Properties p = loadPropertyInstance(classPath);
	    return p.getProperty(propertyName, defaultValue);
	} catch (Exception e) {
	    e.printStackTrace();
	    return null;
    ...
    public static Properties loadPropertyInstance(String classPath) {
	try {
	    Properties p = new Properties();
